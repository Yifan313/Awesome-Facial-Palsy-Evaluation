...
This repository provides an overview of selected key publications on artificial intelligence-based Facial Palsy Evaluation (FPE) **from 2008 to 2024**, as elaborated in the following survey.
```
